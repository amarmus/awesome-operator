...
import (
	...
	"github.com/amarmus/awesome-operator.git/internal/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "bd7563f7.awesome-operator.public.net",
	...
	if err != nil {
		setupLog.Error(err, "Unable to create GCP service")
	}
